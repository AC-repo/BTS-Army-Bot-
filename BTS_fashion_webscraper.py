...
member_sites = {
    ...
    'Jin': ['https://jin.bts.ibighit.com', 'https://jin-army.tumblr.com'],
    'Suga': ['https://suga.bts.ibighit.com', 'https://suga-army.tumblr.com'],
    'J-Hope': ['https://jhope.bts.ibighit.com', 'https://jhope-army.tumblr.com'],
    'Jimin': ['https://jimin.bts.ibighit.com', 'https://jimin-army.tumblr.com'],
    'V': ['https://v.bts.ibighit.com', 'https://v-army.tumblr.com'],
    'Jungkook': ['https://jungkook.bts.ibighit.com', 'https://jungkook-army.tumblr.com']
}
